<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fuente_View.aspx.cs" Inherits="SistemaGestionIndicadores.Fuente_View" %>
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						<%foreach(var item in listaFuente)
						{
%>
						<tr>
							<td>
