<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoIndicador_View.aspx.cs" Inherits="SistemaGestionIndicadores.TipoIndicador_View" %>
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							<a href="#crudModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Gestionar Tipo Indicador</span></a>
						</div>
					</div>
				</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
							<div class="modal-header">						
								<h4 class="modal-title">Gestión Tipo Indicador</h4>
